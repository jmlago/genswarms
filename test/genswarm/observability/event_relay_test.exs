defmodule Genswarm.Observability.EventRelayTest do
  use ExUnit.Case, async: false

  alias Genswarm.CLI.SwarmRegistry
  alias Genswarm.Observability.{EventRelay, LogStore}
  ...
  describe "relay" do
    test "re-broadcasts newly persisted events onto the LogStore PubSub topics" do
      ...
      LogStore.subscribe()
      Phoenix.PubSub.subscribe(Genswarm.PubSub, "log_store:events:relay-c")
