defmodule Genswarm.Backends.BwrapBackend do
  @moduledoc """
  ...
  @behaviour Genswarm.Backends.BackendBehaviour

  alias Genswarm.Backends.Bwrap.{OverlayManager, CgroupManager, AgentTelemetry}
  ...
  defp find_wrapper_path do
    ...
    # even when genswarm is a transitive dependency
    search_paths = [
      Path.join(:code.priv_dir(:genswarm), "szc-wrapper-fifo.sh"),
      Path.join(:code.priv_dir(:genswarm), "szc-wrapper.sh")
    ]
