defmodule Genswarm.Config.SwarmConfig do
  @moduledoc """
  ...
  def backend_module(:bwrap), do: Genswarm.Backends.BwrapBackend
  def backend_module({:bwrap, _}), do: Genswarm.Backends.BwrapBackend
  def backend_module(:local), do: Genswarm.Backends.LocalBackend
  def backend_module({:docker, _}), do: Genswarm.Backends.DockerBackend
  def backend_module({:docker, _, _}), do: Genswarm.Backends.DockerBackend
  def backend_module({:ssh, _}), do: Genswarm.Backends.SSHBackend
  def backend_module({:ssh, _, _}), do: Genswarm.Backends.SSHBackend
  def backend_module(:mock), do: Genswarm.Backends.MockBackend
  def backend_module({:mock, _}), do: Genswarm.Backends.MockBackend
