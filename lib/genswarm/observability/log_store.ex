defmodule Genswarm.Observability.LogStore do
  @moduledoc """
  ...
  def subscribe do
    Phoenix.PubSub.subscribe(Genswarm.PubSub, @pubsub_topic)
  end
  ...
  def subscribe(swarm_name) do
    Phoenix.PubSub.subscribe(Genswarm.PubSub, "#{@pubsub_topic}:#{swarm_name}")
  end
  ...
  @spec unsubscribe() :: :ok
  def unsubscribe do
    Phoenix.PubSub.unsubscribe(Genswarm.PubSub, @pubsub_topic)
  end
