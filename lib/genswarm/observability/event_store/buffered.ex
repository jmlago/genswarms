defmodule Genswarm.Observability.EventStore.Buffered do
  @moduledoc """
  ...
  @default_inner Genswarm.Observability.EventStore.Sqlite

  defp config, do: Application.get_env(:genswarm, __MODULE__, [])
  ...
  defmodule Writer do
    ...
    @impl true
    def init(_) do
      cfg = Application.get_env(:genswarm, Buffered, [])

      state = %{
        buffer: [],
        count: 0,
        inner: Keyword.get(cfg, :inner, Genswarm.Observability.EventStore.Sqlite),
